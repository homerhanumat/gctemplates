...
preface: >
  This is an example of a thesis setup to use the georgetown thesis document class.
...
# This chunk ensures that the georgetowntemplates package is
# installed and loaded. This georgetowntemplates package includes
# the template files for the thesis and also two functions
# used for labeling and referencing
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(georgetowntemplates)){
  library(devtools)
  devtools::install_github("homerhanumat/georgetowntemplates")
}
library(georgetowntemplates)
```
